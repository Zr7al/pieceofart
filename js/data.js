  ...
  projects: [
    {
      ...
      ar: {
        ...
        philosophy:  'وصف المشروع : تصميم يرفض التكلف ويحتفي بالبساطة. في بالميرا، قمنا بصياغة الفراغات من خامات فطرية طينٌ يحفظ برودة المكان، وخشبٌ يمنح الدفء البصري. مشروع يجمع تناقضات الجمال من هيبة الاسطبلات وسرعة الخيل، إلى سكون السبا وعمق المسبح الكبير. بالميرا ليست مجرد منتجع، هي عودة واعية للطبيعة.'
      }
    },
    {
      id:       'omar-badran',
  ...
  translations: {
    en: {
      ...
      modal: {
        ...
        year:       'Year',
        area:       'Area',
        philosophy: 'Project Description'
      },
      aboutPage: {
